...
4. Press `Ctrl-k` to return to Search and edit the current query again, or press `Enter` to open the selected result. A content result initially highlights its matching line.
