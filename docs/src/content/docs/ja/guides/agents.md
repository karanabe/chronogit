---
title: コーディングエージェントと並行して使う
description: 任意のコマンド引き渡しスキルを設定し、コーディングエージェントの作業中に別ターミナルでChronoGitを自分で操作します。
tags:
  - エージェント
  - Codex
  - Claude
...
| 優先度 | エージェント | 連携方針 |
| --- | --- | --- |
| 1 | **OpenAI Codex** | コマンド引き渡しの第一対象です。コンパニオンスキルは、まずCodex向けに設計・検証します。 |
